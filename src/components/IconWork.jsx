...
export default function IconWork(props) {
	return <svg class={ props.class } viewBox="0 0 72 72" xmlns="http://www.w3.org/2000/svg">
		<title>{ __('icon.Work') }</title>
		<g>
			...
			<path fill="#A57939" stroke="none" d="M42.4922,41.6533H30.167H12.5328l0.0006,0.0206c0.5383,0.0165-0.525,1.3157-0.525,1.858l0.4953,15.3184 h46.9289V42.6877c0-0.4933-0.637-0.8842-0.1675-0.9664l0.0017-0.068H42.4922z"/></g>
		<g />
		<g />
		<g />
		<g>
